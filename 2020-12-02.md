...
# Partes del examen
## Almacenar la posicion GPS en la base de datos
## Añadir un XSS
## Añadir otro valor
## Hacer la resta

## Lo primero que vamos a hacer es dividirnos por partes.
...
### 3. Añadir un XSS, usaremos el de implementar y reducir realizado en clase el lunes 30-11-2020
...
### 4. Nos pide que utilicemos otro valor, podemos hacer uqe nos salga una alerta.
